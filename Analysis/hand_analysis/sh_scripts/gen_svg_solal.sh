...
declare -a fn_names=(
	      ...
	      "map_init_free_list" "map_get_bucket" "map_get_free_list" "map_get_node"
...
do
	python ../py_scripts/asm_scripts/objdump_to_cfg.py solal_stateful_objdump.txt $fn_name > $fn_name.txt
